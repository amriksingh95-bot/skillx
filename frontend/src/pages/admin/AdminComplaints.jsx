    ...
    },
    {
      ...
      render: (row) => (
        <button
          ...
          className="p-1.5 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700/80 rounded-lg text-slate-600 dark:text-slate-300 transition-colors flex items-center justify-center"
            ...
            <form onSubmit={handleUpdateStatus} className="border-t border-slate-100 dark:border-dark-border pt-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-end">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-sm font-bold shadow-md shadow-rose-500/10 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
                >
                  {isUpdatingStatus ? (
